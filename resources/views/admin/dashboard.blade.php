                        ...
                        <div class="col-span-12 space-y-6">
                            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
                                <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                                    <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-purple-100 dark:bg-purple-500/15">
                                        <svg class="fill-purple-600 dark:fill-purple-500" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <a href="/admin/verifikasi" class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                                    ...
                                    <div class="mt-5 flex items-end justify-between">
                                        <div>
                                            <span class="text-sm text-gray-500 dark:text-gray-400">Belum Diverifikasi</span>
                                            <h4 class="mt-2 text-title-sm font-bold text-gray-800 dark:text-white/90">
                                                {{ $belum_verifikasi }}
                                            </h4>
                                        </div>
