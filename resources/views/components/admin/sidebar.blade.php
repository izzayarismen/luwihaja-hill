    ...
    <div     :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <a href="/">
            <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
                <img class="dark:hidden" src="/images/logo-admin.png" alt="Logo" />
                <img           class="hidden dark:block"           src="/images/logo-admin.png"
                    alt="Logo"         />
                </span>

            <img         class="logo-icon"         :class="sidebarToggle ? 'lg:block' : 'hidden'"
                src="images/logo-icon.png" alt="Logo"       />
            </a>
        </div>
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <li>
                        <a               href="{{ url('profile') }}"
                            ...
                            _>
                            <svg
                                :class="(selected === 'Profile') && (page === 'profile') ? 'menu-item-icon-active' :
                    ...
                    <li>
                        <a               href="{{ url('blank') }}"               class="menu-item group"
