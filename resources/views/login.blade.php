...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'dark bg-gray-900': darkMode === true }">
    ...
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
        <div class="relative flex flex-col justify-center w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
            <div class="relative items-center hidden w-full h-full lg:grid lg:w-1/2" style="background-image: url('https://s-light.tiket.photos/t/01E25EBZS3W0FY9GTG6C42E1SE/t_htl-dskt/tix-hotel/images-web/2022/09/09/ca47247b-1609-49f1-a340-47cbf7a50e1d-1662720329001-b0a8ba24aa1bd18dad182359e7538cf5.jpg'); background-size: cover;">
            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-5">
                                <p
                                    ...
                                    Belum punya akun?
                                    <a href="/register"
                                        class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Daftar</a>
                                    disini.
                                </p>
                            </div>
                        </div>
